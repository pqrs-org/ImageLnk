...
class ImageLnkTest extends PHPUnit_Framework_TestCase
{
    ...
    function test_instagram1()
    {
        ...
        $imageurls = array(
            'https://igcdn-photos-e-a.akamaihd.net/hphotos-ak-xaf1/t51.2885-15/e35/11356624_508726059287524_1160649839_n.jpg',
        );
        $this->check_response($url, $title, $imageurls);
    }
    ...
    function test_dropbox1()
    {
        ...
        $imageurls = array(
            'https://photos-6.dropbox.com/t/2/AABFxaIWVO2WMOkaZT7oMOSDkkAwbjlHCn2Onv-BZqQxow/12/14480761/png/1024x768/2/_/0/4/130911-0001.png/CPnq8wYgASACIAMgBCAFIAYgBygBKAIoBw/wkq0b9126koq3ky/AAAJOkCa_pv3gfGYZNLNPvrqa/130911-0001.png',
        );
        $this->check_response($url, $title, $imageurls);
    }
}
